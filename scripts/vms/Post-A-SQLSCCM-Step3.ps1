<#
.SYNOPSIS
    Step 3: Install SSMS on A-SQLSCCM. Run on Host A.
    Prereqs: A-SQLSCCM domain-joined, media share accessible.
#>
[CmdletBinding()]
param(
...
Write-LabLog 'Installing SSMS on A-SQLSCCM...' -Step 'A-SQLSCCM'
...
Write-LabLog 'A-SQLSCCM Step 3 complete.' -Level SUCCESS -Step 'A-SQLSCCM'
