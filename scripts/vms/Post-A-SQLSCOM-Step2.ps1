<#
.SYNOPSIS
    Step 2: Install SQL 2019 on A-SQLSCOM (no gMSA, no Always On). Run on Host A.
    Prereqs: A-SQLSCOM domain-joined.
#>
[CmdletBinding()]
param(
...
# ── Format data disk ─────────────────────────────────────────────────────────
Write-LabLog 'Initializing data disk as D:...' -Step 'A-SQLSCOM'
...
Write-LabLog 'Installing SQL Server 2019 on A-SQLSCOM...' -Step 'A-SQLSCOM'
...
Write-LabLog 'A-SQLSCOM Step 2 complete.' -Level SUCCESS -Step 'A-SQLSCOM'
