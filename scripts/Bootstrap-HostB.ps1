<#
.SYNOPSIS
    Full bootstrap for Hyper-V Host B (Site B). Runs via Azure Custom Script Extension.

.DESCRIPTION
    Identical logic to Bootstrap-HostA.ps1. Only the site variables and VM list differ.
    See Bootstrap-HostA.ps1 for full function documentation.

.PARAMETER AdminPassword
    Password injected into all nested VMs via unattend.xml.

.PARAMETER TailscaleAuthKey
    Pre-auth key for Tailscale registration.
...
$VmDefinitions = @(
    [PSCustomObject]@{ Name = 'B-SCCM';    RamGB = 12; VCPU = 4; DiskGB = 150; IPOctet = '3' }
    [PSCustomObject]@{ Name = 'B-SQLSCCM'; RamGB = 8;  VCPU = 4; DiskGB = 150; IPOctet = '4' }
    [PSCustomObject]@{ Name = 'B-MPDP';    RamGB = 6;  VCPU = 2; DiskGB = 100; IPOctet = '5' }
    [PSCustomObject]@{ Name = 'B-DFSR';    RamGB = 4;  VCPU = 2; DiskGB = 150; IPOctet = '7' }
)
...
Write-LabLog '================================================================'
Write-LabLog "Bootstrap-HostB.ps1 started - Site $SiteName"
